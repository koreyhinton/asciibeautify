...
class AsciiBeautifyDemo extends LitElement {
  ...
  async updated(changedProps) {
    if (
      changedProps.has("ascii") ||
      changedProps.has("selectedTheme") ||
    ...
    return html`
      ...
      <button-container>
        <mwc-button
          @click=${() => {
            const asciiBeautify =
              this.shadowRoot.querySelector("ascii-beautify");
...
`;
    ...
    el.setAttribute(
      "href",
      "data:text/plain;charset=utf-8," + encodeURIComponent(xpm)
    );
